    ...
    // Ajouter l'utilisateur
            ...
            if (isset($_FILES['profile-photo']) && $_FILES['profile-photo']['error'] == UPLOAD_ERR_OK){
                ...
                if (in_array($fileExtension, $allowedExts)) {
                    ...
                    $uploadFileDir = 'C:/Users/pc/upload/';  // Dossier local sur votre machine
                    $destFilePath = $uploadFileDir . $newFileName;

                    // Déplacer le fichier téléchargé vers le dossier spécifié
                    if (move_uploaded_file($fileTmpPath, $destFilePath)) {
                        // Image téléchargée avec succès, on enregistre le chemin dans la base de données
                        $profilePhoto = $newFileName; // On stocke le chemin du fichier dans la base de données
                    } else {
            ...
            // Créer un objet User
            $user = new User($email, $password, $firstname, $lastname,$gender,$phone,$profilePhoto);
...
?><!-- Formulaire de création de compte -->
    <div class="form-container">
        ...
        <form id="signup-form" action="inscription.php" method="POST" enctype="multipart/form-data">
            <!-- Prénom -->
